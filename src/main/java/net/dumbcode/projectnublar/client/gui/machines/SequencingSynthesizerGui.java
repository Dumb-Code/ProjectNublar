...
public class SequencingSynthesizerGui extends TabbedGuiContainer {
    ...
    public SequencingSynthesizerGui(EntityPlayer player, SequencingSynthesizerBlockEntity blockEntity, TabInformationBar info, int tab) {
