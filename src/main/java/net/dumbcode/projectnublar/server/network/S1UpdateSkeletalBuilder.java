...
public class S1UpdateSkeletalBuilder implements IMessage {
    ...
    public static class Handler implements IMessageHandler<S1UpdateSkeletalBuilder, IMessage> {
        @Override
        public IMessage onMessage(S1UpdateSkeletalBuilder message, MessageContext ctx) {
