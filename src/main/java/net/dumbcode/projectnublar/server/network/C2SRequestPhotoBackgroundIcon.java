...
public class C2SRequestPhotoBackgroundIcon {
    ...
    public static C2SRequestPhotoBackgroundIcon fromBytes(FriendlyByteBuf buf) {
    ...
    public static void toBytes(C2SRequestPhotoBackgroundIcon packet, FriendlyByteBuf buf) {
