...
public class C2SVehicleInputStateUpdated {
    ...
    public static C2SVehicleInputStateUpdated fromBytes(FriendlyByteBuf buf) {
        return new C2SVehicleInputStateUpdated(buf.readInt(), buf.readInt());
    }

    public static void toBytes(C2SVehicleInputStateUpdated packet, FriendlyByteBuf buf) {
