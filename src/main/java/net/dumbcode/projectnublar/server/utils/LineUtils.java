...
public class LineUtils {
    ...
    public static double[] liangBarskyIntersect(BlockPos position, BlockPos fromPos, BlockPos toPos) {
        Vec3d from = new Vec3d(fromPos).addVector(0.5, 0.5, 0.5);
        Vec3d to = new Vec3d(toPos).addVector(0.5, 0.5, 0.5);
        ...
        if(result != null && reverseResult != null) {
            return new double[]{result.hitVec.x, reverseResult.hitVec.x, result.hitVec.z, reverseResult.hitVec.z};
        }
        return null;
    }
