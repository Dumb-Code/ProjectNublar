...
public enum FossilTier {
    WEATHERED(0, 40, 0.3, 1),
    FRAGMENTED(0.05f, 20, 0.3, 2),
    COMMON(0.1f, 15, 0.3, 3),
    UNEARTHED(0.2f, 10, 0.6, 1),
    ANCIENT(0.3f, 5, 0.6, 1),
    WELL_PRESERVED(0.4f, 4, 0.6, 2),
    EXQUISITE(0.5f, 3, 0.6, 2),
    RARE(0.7f, 1.5f, 0.6, 3),
    PRIMAL(0.9f, 1, 0.6, 3),
    TIMELESS(1, 0.5f, 1, 0);
    ...
    FossilTier(float DNAGatherChance, float weight, double dnaValue, int crackLevel) {
